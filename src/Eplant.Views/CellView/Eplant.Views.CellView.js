	...
	this.Xhrs.loadDataXhr=$.ajax({
		...
		this.Xhrs.loadSamplesXhr=$.ajax({
			...
			success: $.proxy(function(response) {
				...
				Eplant.queue.add(this.eFPView.updateDisplay, this.eFPView,null,this.eFPView.geneticElement.identifier+"_Loading");

				/* Finish loading */
				//this.eFPView.createViewHeatmap();
				Eplant.queue.add(this.eFPView.createViewHeatmap, this.eFPView,null,this.eFPView.geneticElement.identifier+"_Loading");

				/* bind events to svg elements eFP */
				//this.eFPView.bindSvgEvents();
				Eplant.queue.add(this.eFPView.bindSvgEvents, this.eFPView,null,this.eFPView.geneticElement.identifier+"_Loading");
				/* Finish loading */
				//this.eFPView.loadFinish();
				Eplant.queue.add(this.eFPView.loadFinish, this.eFPView,null,this.eFPView.geneticElement.identifier+"_Loading");
			}, wrapper),
