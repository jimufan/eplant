...
/**
 * Eplant.BaseViews.EFPViewJson.Legend class
 * Coded by Hans Yu
 * UI designed by Jamie Waese
 *
 * @constructor
 * @param {Eplant.BaseViews.EFPViewJson} eFPView The EFPView that owns this legend.
 */
Eplant.BaseViews.EFPViewJson.Legend = function(eFPView) {
	/* Attributes */
 ...
 * Updates the legend.
 */
Eplant.BaseViews.EFPViewJson.Legend.prototype.update = function() {
	/* Clear canvas */
 ...
 */
Eplant.BaseViews.EFPViewJson.Legend.prototype.attach = function() {
	$(Eplant.Views.WorldView.domContainer).append(this.domContainer);
};

/**
 * Detaches the legend to the view.
 */
Eplant.BaseViews.EFPViewJson.Legend.prototype.detach = function() {
 ...
 */
Eplant.BaseViews.EFPViewJson.Legend.prototype.show = function() {
	this.isVisible = true;
 ...
 * Hides the legend.
 */
Eplant.BaseViews.EFPViewJson.Legend.prototype.hide = function() {
 ...
 * Removes the legend.
 */
Eplant.BaseViews.EFPViewJson.Legend.prototype.remove = function() {
	/* Remove DOM elements */
